package com.star.operit.ui.features.token
...
import com.star.operit.ui.features.token.components.UrlConfigDialog
import com.star.operit.ui.features.token.model.NavDestination
import com.star.operit.ui.features.token.model.getIconForIndex
import com.star.operit.ui.features.token.preferences.UrlConfigManager
...
fun TokenConfigWebViewScreen(onNavigateBack: () -> Unit) {
    ...
    // 获取URL配置
    val urlConfig by urlConfigManager.urlConfigFlow.collectAsState(initial = com.star.operit.ui.features.token.model.UrlConfig())
