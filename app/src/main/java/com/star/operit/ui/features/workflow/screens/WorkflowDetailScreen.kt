package com.star.operit.ui.features.workflow.screens
...
import com.star.operit.data.model.WorkflowNode
...
import com.star.operit.ui.features.workflow.viewmodel.WorkflowViewModel
import com.star.operit.ui.features.workflow.components.GridWorkflowCanvas
import com.star.operit.ui.features.workflow.components.ConnectionMenuDialog
import com.star.operit.ui.features.workflow.components.NodeActionMenuDialog
import com.star.operit.ui.features.workflow.components.ScheduleConfigDialog
...
fun NodeDialog(
    ...
    val initialActionConfigPairs = if (node is ExecuteNode) {
        node.actionConfig.map { (key, paramValue) ->
            when (paramValue) {
                is com.star.operit.data.model.ParameterValue.StaticValue -> 
                    ParameterConfig(key, false, paramValue.value)
                is com.star.operit.data.model.ParameterValue.NodeReference -> 
