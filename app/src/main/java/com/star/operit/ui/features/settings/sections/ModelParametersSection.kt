package com.star.operit.ui.features.settings.sections
...
import com.star.operit.data.model.StandardModelParameters
...
fun ModelParametersSection(
        ...
        if (config.hasCustomParameters &&
            ...
            try {
                ...
                val customParamsList =
                    json.decodeFromString<List<com.star.operit.data.model.CustomParameterData>>(
                        config.customParameters
                    )
    ...
    // 状态
    var parameterToEdit by remember { mutableStateOf<com.star.operit.data.model.CustomParameterData?>(null) }
...
private fun convertCustomParameterDataToModelParameter(
    customParam: com.star.operit.data.model.CustomParameterData
): ModelParameter<*> {
...
): com.star.operit.data.model.CustomParameterData {
    return com.star.operit.data.model.CustomParameterData(
        id = param.id,
        name = param.name,
...
private fun AddCustomParameterDialog(
    onDismiss: () -> Unit,
    onSave: (com.star.operit.data.model.CustomParameterData) -> Unit,
    existingParam: com.star.operit.data.model.CustomParameterData? = null
) {
