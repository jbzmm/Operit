package com.star.operit.ui.features.demo.viewmodel
...
import com.star.operit.ui.features.demo.state.DemoStateManager
...
class ShizukuDemoViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val uiState: StateFlow<com.star.operit.ui.features.demo.state.DemoScreenState> =
