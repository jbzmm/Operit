...
import com.star.operit.data.model.CustomParameterData
...
import com.star.operit.data.model.ApiKeyInfo
...
class ModelConfigManager(private val context: Context) {
    ...
    suspend fun updateModelConfig(
            ...
            apiEndpoint: String,
            modelName: String,
            apiProviderType: com.star.operit.data.model.ApiProviderType,
...
private fun ModelParameter<*>.toCustomParameterData(): com.star.operit.data.model.CustomParameterData {
