...
import com.star.operit.integrations.externalchat.ExternalChatAcceptedResponse
import com.star.operit.integrations.externalchat.ExternalChatHealthResponse
import com.star.operit.integrations.externalchat.ExternalChatHttpRequest
import com.star.operit.integrations.externalchat.ExternalChatRequestExecutor
import com.star.operit.integrations.externalchat.ExternalChatResponseMode
...
import com.star.operit.integrations.externalchat.ExternalChatStreamEnvelope
import com.star.operit.integrations.externalchat.ExternalChatStreamingStartResult
...
class ExternalChatHttpServer(
    ...
    private fun sseResponse(request: ExternalChatHttpRequest, resolvedRequestId: String): Response {
        ...
        val streamingSessionRef =
            AtomicReference<com.star.operit.integrations.externalchat.ExternalChatStreamingSession?>(
                null
            )
