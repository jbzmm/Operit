package com.star.operit.core.tools
...
data class WorkflowDetailResultData(
    ...
    val name: String,
    val description: String,
    val nodes: List<com.star.operit.data.model.WorkflowNode>,
    val connections: List<com.star.operit.data.model.WorkflowNodeConnection>,
    val enabled: Boolean,
    val createdAt: Long,
    val updatedAt: Long,
    val lastExecutionTime: Long? = null,
    ...
    override fun toString(): String {
        ...
        nodes.forEach { node ->
            when (node) {
                is com.star.operit.data.model.TriggerNode -> {
                ...
                is com.star.operit.data.model.ExecuteNode -> {
                ...
                is com.star.operit.data.model.ConditionNode -> {
                ...
                is com.star.operit.data.model.LogicNode -> {
                ...
                is com.star.operit.data.model.ExtractNode -> {
