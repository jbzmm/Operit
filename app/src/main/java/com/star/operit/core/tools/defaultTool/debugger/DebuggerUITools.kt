...
import com.star.operit.core.tools.UIActionResultData
import com.star.operit.core.tools.UIPageResultData
import com.star.operit.core.tools.defaultTool.accessbility.AccessibilityUITools
...
import com.star.operit.core.tools.system.ShellIdentity
            ...
            try {
                ...
                val tapTool =
                        AITool(
                                ...
                                parameters =
                                        listOf(
                                                com.star.operit.data.model.ToolParameter(
                                                        "x",
                                                        centerX.toString()
                                                ),
                                                com.star.operit.data.model.ToolParameter(
