package com.star.operit.core.tools.defaultTool.debugger
...
import com.star.operit.core.tools.defaultTool.accessbility.AccessibilityFileSystemTools
...
import com.star.operit.util.AndroidUserPathUtils
...
open class DebuggerFileSystemTools(context: Context) : AccessibilityFileSystemTools(context) {
    companion object {
        ...
        private const val OPERIT_PACKAGE = "com.star.operit"
