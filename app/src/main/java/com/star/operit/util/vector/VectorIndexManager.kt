    ...
    fun initIndex() {
        index = if (indexFile != null && indexFile.exists()) {
            try {
                ...
                com.star.operit.util.AppLogger.e("VectorIndexManager", "Failed to load index, creating new one.", e)
    ...
    fun save() {
        if (indexFile != null && index != null) {
            try {
                ...
                com.star.operit.util.AppLogger.e("VectorIndexManager", "Failed to save index to ${indexFile.absolutePath}", e)
            }
        }
    }
